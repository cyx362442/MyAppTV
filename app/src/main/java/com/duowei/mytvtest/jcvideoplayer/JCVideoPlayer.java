package com.duowei.mytvtest.jcvideoplayer;
...
import com.duowei.mytvtest.JCVideoPlayerStandard;
import com.duowei.mytvtest.R;
    ...
    public void setUiWitStateAndScreen(int state) {
        ...
        switch (currentState) {
            ...
            case CURRENT_STATE_ERROR:
                cancelProgressTimer();
                break;
            case CURRENT_STATE_AUTO_COMPLETE://播放结束事件
                cancelProgressTimer();
